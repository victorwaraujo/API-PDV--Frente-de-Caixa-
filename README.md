...
API para um PDV (Frente de Caixa) realizado no desafio final do curso de backend da Cubos Academy. O projeto foi divido em três sprints semanais e foi realizada em equipe de 5 pessoas. Foi utilizado Scrum como metodologia ágil para a elaboração do mesmo.
